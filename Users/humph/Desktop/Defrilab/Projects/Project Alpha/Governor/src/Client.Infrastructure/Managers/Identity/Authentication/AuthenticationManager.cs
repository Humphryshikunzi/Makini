...
using _.Client.Infrastructure.Authentication;
...
using _.Client.Infrastructure.Routes;
using _.Shared.Constants.Storage;
using Microsoft.Extensions.Localization;

namespace _.Client.Infrastructure.Managers.Identity.Authentication
{
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                ((AppStateProvider)this._authenticationStateProvider).MarkUserAsAuthenticated(model.Email);
