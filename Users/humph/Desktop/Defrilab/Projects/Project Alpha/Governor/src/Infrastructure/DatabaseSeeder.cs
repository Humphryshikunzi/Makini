...
using _.Infrastructure.Helpers;
using _.Shared.Constants.Permission;
using _.Shared.Constants.Role;
using _.Shared.Constants.User;
    ...
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        private void AddAdministrator()
        {
            Task.Run(async () =>
            {
                ...
                var adminRole = new AppUserRole(RoleConstants.AdministratorRole, _localizer["Administrator role with full permissions"]);
                ...
                var superUser = new AppUser
                {
                    FirstName = "Eduun",
                    LastName = "Muraya",
                    Email = "eduuhadmin@speed.com",
                    UserName = "eduuhspeeder",
                    EmailConfirmed = true,
        ...
        private void AddBasicUser()
        {
            ...
            {
                //Check if Role Exists
                var basicRole = new AppUserRole(RoleConstants.BasicRole, _localizer["Basic role with default permissions"]);
