...
using _.Application.Features.ExtendedAttributes.Commands.AddEdit;
using _.Application.Features.ExtendedAttributes.Commands.Delete;
using _.Application.Features.ExtendedAttributes.Queries.Export;
using _.Application.Features.ExtendedAttributes.Queries.GetAll;
using _.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using _.Application.Features.ExtendedAttributes.Queries.GetById;
using _.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace _.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
