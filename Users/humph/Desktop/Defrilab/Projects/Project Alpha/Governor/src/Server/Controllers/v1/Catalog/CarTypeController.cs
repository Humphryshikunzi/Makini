...
using _.Application.Features.Brands.Commands.Delete;
using _.Application.Features.Brands.Queries.Export;

namespace _.Server.Controllers.v1.Catalog
{
    public class CarTypeController : BaseApiController<CarTypeController>
    {
        /// <summary>
        /// Get All Brands
        /// </summary>
