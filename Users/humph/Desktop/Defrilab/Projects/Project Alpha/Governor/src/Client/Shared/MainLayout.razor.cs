...
using _.Client.Infrastructure.Managers.Identity.Roles;
using _.Client.Infrastructure.Settings;
...
namespace _.Client.Shared
{
  public partial class MainLayout : IDisposable
  {
    ...
    protected override async Task OnInitializedAsync()
    {
      ...
      hubConnection.On<Location, string>(ApplicationConstants.SignalR.ReceiveNewLocation, (location, speedgovid) =>
      {
        Console.WriteLine("my name is eduuh");
