...
namespace _.Infrastructure.Contexts
{
    public abstract class AuditableContext : IdentityDbContext<AppUser, AppUserRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, AppuserRoleClaims, IdentityUserToken<string>>
    {
