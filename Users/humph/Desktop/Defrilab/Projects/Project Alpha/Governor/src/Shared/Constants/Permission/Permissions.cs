...
namespace _.Shared.Constants.Permission
{
    public static class Permissions
    {
        public static class SpeedGovernor
        {
            public const string View = "Permissions.SpeedGovenor.View";
            public const string Create = "Permissions.SpeedGovenor.Create";
            public const string Edit = "Permissions.SpeedGovenor.Edit";
            public const string Delete = "Permissions.SpeedGovenor.Delete";
            public const string Export = "Permissions.SpeedGovenor.Export";
            public const string Search = "Permissions.SpeedGovenor.Search";
        }
