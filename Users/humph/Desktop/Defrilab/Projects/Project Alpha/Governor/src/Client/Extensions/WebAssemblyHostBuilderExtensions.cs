...
using _.Client.Infrastructure.Managers;
using _.Client.Infrastructure.Managers.Preferences;
...
namespace _.Client.Extensions
{
    public static class WebAssemblyHostBuilderExtensions
    {
        private const string ClientName = "ClientWeb";
